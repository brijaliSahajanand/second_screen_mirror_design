...
import com.screenmirror.screentv.tvsharingapp.Activity.Video.Player.CustomUi.WrapContentLinearLayoutManager;
import com.screenmirror.screentv.tvsharingapp.Activity.Video.Player.videoService.PreferencesUtility;
...
public class PlayVideoActivity extends AppCompatActivity implements PreviewView.OnPreviewChangeListener {
    ...
    private VideoModel currentVideo = new VideoModel();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PreferencesUtility.getInstance(PlayVideoActivity.this).setAllowBackgroundAudio(false);
...
//        CastButtonFactory.setUpMediaRouteButton(this, menu, R.id.media_route_menu_item);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_menu) {
            ...
            GetData.shareVideo(PlayVideoActivity.this, mGlobalVar.playingVideo.getFilepath());
//                startActivity(Intent.createChooser(kxUtils.shareVideo(com.sdcode.videoplayer.PlayVideoActivity.this, mGlobalVar.playingVideo),
...
//            else mGlobalVar.openNotification();
        ...
        previewTimeBar.setPreviewLoader((currentPosition, max) -> {
            ...
            Glide.with(PlayVideoActivity.this)
                    .load(mGlobalVar.playingVideo.getFilepath())
            ...
            public void run() {
                ...
                if (mGlobalVar.getPlayer() != null) {
                    if (mGlobalVar.getPlayer().getPlayWhenReady() != isVideoPlaying) {
                        isVideoPlaying = mGlobalVar.getPlayer().getPlayWhenReady();
                        if (getSupportActionBar() != null)
                            getSupportActionBar().setTitle(mGlobalVar.playingVideo.getVideoTitle());
                        if (isVideoPlaying)
...
//    }
    ...
    private void createDialog(VideoModel videoItem) {
        ...
        txtLocation.setText(videoItem.getFilepath());

        TextView txtVideoFormat = view.findViewById(R.id.txtFormat_value);
        txtVideoFormat.setText(GetData.getFileExtension(videoItem.getFilepath()));

        TextView txtDuration = view.findViewById(R.id.txtDuration_value);
        txtDuration.setText(GetData.timeConversion(videoItem.getVideoDuration()));

        TextView txtDateAdded = view.findViewById(R.id.txtDateAdded_value);
        txtDateAdded.setText(videoItem.getDateadded());
